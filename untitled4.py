# -*- coding: utf-8 -*-
"""
Created on Wed Jun  9 11:40:03 2021
...
t1x=Click(name='retry',scantime=3,
                  waitresponsetime=3,startsign=['./t1.png'],
                  endsign=eeennnd,region=region1,
                  clicktimes=1)
